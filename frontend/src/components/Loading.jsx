...
const Loading = () => {
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center z-50 bg-black bg-opacity-50 backdrop-blur-sm">
      <div className="bg-gradient-to-br from-slate-800 to-slate-900 rounded-xl p-8 shadow-2xl border border-slate-700 max-w-md w-full mx-4 transform transition-all">
        {/* Spinner */}
        <div className="flex justify-center mb-6">
          <div className="relative">
            <div className="w-20 h-20 border-4 border-blue-200 border-opacity-20 rounded-full"></div>
            <div 
              className="w-20 h-20 border-4 border-t-blue-500 border-r-transparent border-b-transparent border-l-transparent rounded-full absolute top-0 left-0 animate-spin"
            ></div>
        ...
        <div className="flex justify-center mt-4">
          <span className="h-2 w-2 bg-blue-400 rounded-full mx-1 animate-pulse" style={{ animationDelay: '0ms' }}></span>
